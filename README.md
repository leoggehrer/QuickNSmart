- [QuickNSmart (Teil A)](#QuickNSmart-teil-a)
  - [Projekt](#projekt)
    - [Projektstruktur](#projektstruktur)
    - [Datenstruktur](#datenstruktur)
    - [Teilprojekt: QuickNSmart.Contracts](#teilprojekt-QuickNSmartcontracts)
      - [Implementierung der Schnittstellen](#implementierung-der-schnittstellen)
    - [Teilprojekt: QuickNSmart.Logic](#teilprojekt-QuickNSmartlogic)
...
Das Projekt 'QuickNSmart' ist ein kleines datenzentriertes Anwendungsbeispiel mit welchem die Erstellung eines Software-Systems dargestellt werden soll. Aufgrund der Komplexität, die ein Software-System im Allgemeinem darstellt, ist die Erstellung des Beispiels in mehreren Abschnitten unterteilt. Die Aufteilung ist wie folgt definiert:  
...
Als Domainname wird 'QuickNSmart' verwendet und steht für die Gesamtlösung 'QuickNSmart'. Das Gesamtprojekt wird in Teilprojekte unterteilt wobei jedes bestimmten Lösungen für einen Teilbereich der Gesamtlösung beinhaltet. Als Namenskonvention für solche Projekt gilt die folgende Regel:  

+ [Domainname].[Bereich] => QuickNSmart.[Bereich]  

Zum Beispiel wird für den Bereich der Schnittstellen der Name 'QuickNSmart.Contracts' generiert. In diesem Projekt befinden sich alle für die Domäne relevanten Schnittstellen. 
...
Die Datenstruktur vom 'QuickNSmart' ist überschaulich und besteht im wesentlichen aus 4 Komponenten welche in der folgenden Tabelle zusammengefasst sind:
...
Die Schnittstelle 'IIdentifyable' definiert eine schreibgeschützte Eigenschaft 'Id'. Diese Eigenschaft kann nur innerhalb des Projektes 'QuickNSmart.Logic' verändert werden. Diese Schnittstelle bildet die Basis für alle anderen Schnittstellen der Kategorie 'Entity'.  
...
namespace QuickNSmart.Contracts.Persistence
{
    /// <summary>
...
Weiters gibt es Eigenschaften mit der Namensform [Entitätsname]Id - wie zum Beispiel die Eigenschaft 'ArtistId'. Eigenschaften, die diese Form aufweisen, enthalten Referenzdaten zu anderen Entitäten. Zum Beispiel enthält die Eigenschaft 'ArtistId' die Identität der Entität 'Artist'. Die Prüfung auf korrekten Inhalt, dieser Eigenschaften, erfolgt im Projekt QuickNSmart.Logic'.  
  
**Hinweis:** Die Implementierung dieser Schnittstellen erfogt im Projekt 'QuickNSmart.Logic' im Bereich 'Entities'.

Im Projekt ist noch eine weitere Schnittstelle definiert. Diese Schnittstelle befindet sich im Ordner 'Client' und stellt den Zugriff auf das Kontroller-Objekt aus dem Projekt 'QuickNSmart.Logic' dar. Alle Kontroller, im Projekt 'MusicStroe.Logic', implementieren diese Schnittstelle.  
...
**Hinweis:** Die Implementierung dieser Schnittstelle erfogt im Projekt 'QuickNSmart.Logic' im Bereich 'Controllers'.

Zusammenfassend - die Ordnerstruktur von 'QuickNSmart.Contracts':

![OrdnerStruktur](QuickNSmartContracts.png)

**Hinweis:** Die Datein mit der Endung '.cd' sind die Klassendiagramme von Visual Studio.

### Teilprojekt: QuickNSmart.Logic
...
Die Entitäten implementieren die Schnittstellen aus dem Projekt 'QuickNSmart.Contracts' und sind im Ordner 'Entities' definiert. Der Klassendesigner zeigt folgendes Diagramm für die persistierenden Entitäten:
...
namespace QuickNSmart.Logic.Entities.Persistence
{
    /// <summary>
...
Die Klasse 'QuickNSmartController\<E, I\>' ist das Bindeglied zwischen den allgemeinen Kontroller-Klassen und den projektspezifischen Kontroller-Klassen. Das bedeutet, dass alle Klassen, welche von 'QuickNSmartController\<E, I\>' abgeleitet sind, Domain-Klassen sind. Die Klassen 'ControllerObject' und 'GenericController\<E, I\>' sind unabhängig vom Domain-Bereich und könnten auch für andere Projekte verwendet werden!

```csharp ({"Type": "FileRef", "File": "Logic/Controllers/Persistence/QuickNSmartController.cs", "StartTag": "//MdStart", "EndTag": "//MdEnd" })
using QuickNSmart.Logic.DataContext;
...
namespace QuickNSmart.Logic.Controllers.Persistence
{
    ...
    internal abstract partial class QuickNSmartController<I, E> : GenericController<I, E>
       ...
       where E : Entities.IdentityObject, I, Contracts.ICopyable<I>, new()
    {
        protected IQuickNSmartContext QuickNSmartContext => (IQuickNSmartContext)Context;
...
Die Klasse 'QuickNSmartController\<E, I\>' führt eine Umwandlung vom allgemeinen 'Context' zum speziellen 'QuickNSmartContext' durch. In diesem konkreten Kontext sind die Auflistungen der entsprechenden Entitäten hinterlegt. Mehr dazu folgt im Abschnitt **DataContext**.  
...
namespace QuickNSmart.Logic.Controllers.Persistence
{
    ...
    /// </summary>
    internal partial class AlbumController : QuickNSmartController<Contracts.Persistence.IAlbum, Entities.Persistence.Album>
    {
        protected override IEnumerable<Entities.Persistence.Album> Set => QuickNSmartContext.Albums;
...
namespace QuickNSmart.Logic.Controllers.Persistence
{
    ...
    /// </summary>
    internal partial class GenreController : QuickNSmartController<Contracts.Persistence.IGenre, Entities.Persistence.Genre>
    {
        protected override IEnumerable<Entities.Persistence.Genre> Set => QuickNSmartContext.Genres;
...
namespace QuickNSmart.Logic.Controllers.Persistence
{
    ...
    /// </summary>
    internal partial class ArtistController : QuickNSmartController<Contracts.Persistence.IArtist, Entities.Persistence.Artist>
    {
        protected override IEnumerable<Entities.Persistence.Artist> Set => QuickNSmartContext.Artists;
...
namespace QuickNSmart.Logic.Controllers.Persistence
{
    ...
    /// </summary>
    internal partial class TrackController : QuickNSmartController<Contracts.Persistence.ITrack, Entities.Persistence.Track>
    {
        protected override IEnumerable<Entities.Persistence.Track> Set => QuickNSmartContext.Tracks;
...
```csharp ({"Type": "FileRef", "File": "DataContext/QuickNSmartFileContext.cs", "StartTag": "//MdStart", "EndTag": "//MdEnd" })
using System;
using System.Collections.Generic;
using System.Linq;
using CommonBase.Extensions;
...
namespace QuickNSmart.Logic.DataContext
{
    abstract partial class QuickNSmartFileContext : FileContext, IQuickNSmartContext
    {
...
using QuickNSmart.Contracts;
using QuickNSmart.Logic.Entities;
using QuickNSmart.Logic.Entities.Persistence;

namespace QuickNSmart.Logic.DataContext.Db
{
    internal partial class DbQuickNSmartContext : DbContext, IContext, IQuickNSmartContext
    {
...
```csharp ({"Type": "FileRef", "File": "DataContext/Csv/CsvQuickNSmartContext.cs", "StartTag": "//MdStart", "EndTag": "//MdEnd" })
using System.Collections.Generic;

namespace QuickNSmart.Logic.DataContext.Csv
{
    internal partial class CsvQuickNSmartContext : QuickNSmartFileContext
    {
        public CsvQuickNSmartContext()
        {
        }
...
```csharp ({"Type": "FileRef", "File": "DataContext/Ser/SerQuickNSmartContext.cs", "StartTag": "//MdStart", "EndTag": "//MdEnd" })
using System.Collections.Generic;

namespace QuickNSmart.Logic.DataContext.Ser
{
    internal partial class SerQuickNSmartContext : QuickNSmartFileContext
    {
        public SerQuickNSmartContext()
        {
        }
...
namespace QuickNSmart.Logic
{
    public static class Factory
    {
        ...
        private static DataContext.IContext CreateContext()
        {
            ...
            {
                result = new DataContext.Csv.CsvQuickNSmartContext();
            }
            ...
            {
                result = new DataContext.Ser.SerQuickNSmartContext();
            }
            return result;
        }
        /// <summary>
