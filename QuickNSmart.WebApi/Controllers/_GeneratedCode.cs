...
namespace QuickNSmart.WebApi.Controllers
{
	...
	using System.Collections.Generic;
	using System.Threading.Tasks;
	using Contract = QuickNSmart.Contracts.Persistence.Account.IIdentityXApplication;
	using Model = Transfer.Persistence.Account.IdentityXApplication;
	[ApiController]
	[Route("Controller")]
	public partial class IdentityXApplicationController : GenericController<Contract, Model>
	{
		[HttpGet("/api/[controller]/MaxPage")]
		public Task<int> GetMaxPageAsync()
		{
...
namespace QuickNSmart.WebApi.Controllers
{
	...
	using System.Collections.Generic;
	using System.Threading.Tasks;
	using Contract = QuickNSmart.Contracts.Business.Account.IAuthentication;
	using Model = Transfer.Business.Account.Authentication;
	[ApiController]
	[Route("Controller")]
	public partial class AuthenticationController : GenericController<Contract, Model>
	{
		[HttpGet("/api/[controller]/MaxPage")]
		public Task<int> GetMaxPageAsync()
		{
