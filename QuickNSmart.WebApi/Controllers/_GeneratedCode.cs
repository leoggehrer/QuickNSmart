namespace QuickNSmart.WebApi.Controllers
{
	...
	using Contract = Contracts.Persistence.TestOneToMany.IInvoice;
	using Model = Transfer.Persistence.TestOneToMany.Invoice;
	[ApiController]
	[Route("Controller")]
...
namespace QuickNSmart.WebApi.Controllers
{
	...
	using System.Collections.Generic;
	using System.Threading.Tasks;
	using Contract = Contracts.Persistence.TestOneToMany.IInvoiceDetail;
	using Model = Transfer.Persistence.TestOneToMany.InvoiceDetail;
	[ApiController]
	[Route("Controller")]
...
namespace QuickNSmart.WebApi.Controllers
{
	...
	using System.Collections.Generic;
	using System.Threading.Tasks;
	using Contract = Contracts.Business.TestOneToMany.IInvoiceDetails;
	using Model = Transfer.Business.TestOneToMany.InvoiceDetails;
	[ApiController]
	[Route("Controller")]
